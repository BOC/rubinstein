 ...
 */
class Hr_Customer_AccountController extends Mage_Core_Controller_Front_Action {
	/**
	...
	public function createPostAction() {
		...
		if ($this->getRequest()->isPost()) {
			...
			if ($this->getRequest()->getPost('create_address')) {
				$address = Mage :: getModel('customer/address')->setData($this->getRequest()->getPost())->setIsDefaultBilling($this->getRequest()->getParam('default_billing', false))->setIsDefaultShipping($this->getRequest()->getParam('default_shipping', false))->setId(null);
	...
	public function confirmAction() {
		...
		try {
			...
			$this->_redirectError(Mage :: getUrl('*/*/index', array (
				'_secure' => true
			)));
			return;
		}
	...
	public function confirmationAction() {
		...
		if ($email) {
			try {
				...
				$this->_redirectError(Mage :: getUrl('*/*/*', array (
					'email' => $email,
					'_secure' => true
				)));
			}
		...
		$this->getLayout()->getBlock('accountConfirmation')->setEmail($this->getRequest()->getParam('email', $email));
	...
	*/
	...
	public function editPostAction() {
		if (!$this->_validateFormKey()) {
			return $this->getResponse()->setRedirect(Mage::getUrl('*/*/edit'));
		}

		if ($this->getRequest()->isPost()) {
			$customer = Mage :: getModel('customer/customer')->setId($this->_getSession()->getCustomerId())->setWebsiteId($this->_getSession()->getCustomer()->getWebsiteId());
		...
		$this->getResponse()->setRedirect(Mage::getUrl('*/*/informations'));
	}
